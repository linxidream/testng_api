...
import com.wmk.api.excepions.ErrorRespStatusException;
...
public class LoginTest extends TestBase {
	...
	/**
	 * 公共header，会在发送请求的时候添加到http header上
	 */
	...
	@Parameters("envName")
	@BeforeSuite
	public void init(@Optional("api-config-login.xml") String envName) throws Exception {
	...
	@BeforeTest
	public void readData(@Optional("case/api-data.xls") String excelPath, @Optional("login") String sheetName) throws DocumentException {
